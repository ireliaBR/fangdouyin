...
-(void)viewDidLoad
{
    ...
    [self cardView];
//    self.colors = @[
//                    [MusicModel modelWithColor:[UIColor redColor]],
//                    [MusicModel modelWithColor:[UIColor yellowColor]],
//                    [MusicModel modelWithColor:[UIColor blueColor]],
//                    [MusicModel modelWithColor:[UIColor greenColor]],
//                    [MusicModel modelWithColor:[UIColor whiteColor]],
//                    [MusicModel modelWithColor:[UIColor blackColor]],
//                    [MusicModel modelWithColor:[UIColor purpleColor]]
//                    ];
